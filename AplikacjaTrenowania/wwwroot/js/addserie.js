document.getElementById("addSeria").addEventListener("click", function () {
    ...
    seria.innerHTML = `
        <div class="seryjka">
            <input type="number" name="Serie[${index}].Kg" placeholder="Kg" class="form-control seria-kg" />
        </div>
        <div class="seryjka">
            <input type="number" name="Serie[${index}].Powtorzenia" placeholder="Powtórzenia" class="form-control seria-powtorzenia" />
        </div>
        <div class="seryjka">
